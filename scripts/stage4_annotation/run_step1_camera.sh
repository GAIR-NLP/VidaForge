...
RUN_ID="${RUN_ID:-${INPUT_RUN_ID}_camera}"
...
LIMIT="${LIMIT:-null}"
RESUME="${RESUME:-false}"
INPUT_PATH="${INPUT_PATH:-${DATA_DIR}/meta/stage3_selection/step4_select/run_id_${INPUT_RUN_ID}}"
OUTPUT_PATH="${DATA_DIR}/meta/stage4_annotation/step1_camera/run_id_${RUN_ID}"
