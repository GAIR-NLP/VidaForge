...
RUN_ID="${RUN_ID:-${INPUT_RUN_ID}_tag}"
...
LIMIT="${LIMIT:-null}"
RESUME="${RESUME:-false}"
INPUT_PATH="${INPUT_PATH:-${DATA_DIR}/meta/stage4_annotation/step2_caption/run_id_${INPUT_RUN_ID}}"
OUTPUT_PATH="${DATA_DIR}/meta/stage4_annotation/step3_tag/run_id_${RUN_ID}"
